...
const sequelize = new Sequelize('dbfarmacia', 'root', 'Lola2201', {
    host: 'localhost',
    dialect: 'mysql'
});
...
const ReportesCompra = require('./routes/ReportesCompra')
const ReporteVenta = require('./routes/ReportesVenta')
...
app.use('/api/reportescompra', ReportesCompra)
